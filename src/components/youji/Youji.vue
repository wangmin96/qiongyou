  ...
  <div>
    <div class="detail">
      <div class="header" :style="'background-color:'+$store.state.color">
        <img src="@/assets/image/back.png" v-on:click="goBack"/>
      ...
      <div class="content">
        ...
        <div class="footer">
          <ul>
            <li class="one"><img src="@/assets/image/eyes.png"/>&nbsp;&nbsp;20</li>
            <li class="two"><img src="@/assets/image/goods.png"/>&nbsp;&nbsp;40</li>
            <li class="three"><img src="@/assets/image/information.png"/>评论</li>
          </ul>
        </div>
      </div>
    </div>
...
<style scoped>
  ...
  .slide3 {
    height: 3rem;
    background: url("../../assets/image/03.jpg") ;
    background-size: 100% 100%;
  }
  .slide4 {
    height: 3rem;
    background: url("../../assets/image/04.jpg") ;
    background-size: 100% 100%;
  }
  .detail{
    width: 100%;
